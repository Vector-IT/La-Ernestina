...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($_POST["operacion"]) {
        case 1: //Solicitar parametros
            $strSQL = "SELECT NombRepo, SQLRepo, CantParams, TipoParam, Tabla, Campo, ColumnFoot, FooterEsMoneda";
        ...
        case 2: //Armar reporte
            ...
            $strSalida.= $crlf.'<h4>'.$fila["NombRepo"].' '.$_POST["Params"][0].'</h4>';
            ...
            if ($fila["ColumnFoot"] != "") {
                ...
                for ($I = 1; $I <= $tabla->field_count; $I++) {
                    if ($I == $fila["ColumnFoot"]) {
